				...
				<div class="row mb-5 pb-3 no-gutters">
						...
						<div class="con con-1 w-100 py-5">
							<div class="con-info w-100 text-center">
								<div class="icon d-flex align-items-center justify-content-center">
									<span class="ion-ios-call"><img style="margin: 5px;" src="./imagenes/llamada-telefonica.png" width="25px" alt=""></span>
								</div>
								<div class="text">
									<span>(0571) 7045 641 Ext 101-102</span>
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-4 mb-md-0 mb-4 d-flex">
						<div class="con con-2 w-100 py-5">
							<div class="con-info w-100 text-center">
								<div class="icon d-flex align-items-center justify-content-center">
									<span class="ion-ios-mail"><img style="margin: 5px;" src="./imagenes/email.png" width="25px" alt=""></span>
								</div>
								<div class="text">
									<span>atencionalcliente@desmedicos.com</span>
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-4 mb-md-0 mb-4 d-flex">
						<div class="con con-3 w-100 py-5">
							<div class="con-info w-100 text-center">
								<div class="icon d-flex align-items-center justify-content-center">
									<span class="ion-ios-pin"><img style="margin: 5px;" src="./imagenes/mapas-y-banderas.png" width="25px" alt=""></span>
								</div>
								<div class="text">
									<span>Cra. 77 B Bis # 76 - 68</span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-7">
						<div class="row">
							<div class="col-md-4 mb-md-0 mb-4">
								<h2 class="footer-heading">Hecha por:</h2>
							   <a href="../../DesarrolladoresD.S/index.php"> <img style="margin-left: 200px;" type="button"  src="./imagenes/Logo-removebg-preview.png" alt=""></a>
							</div>
					
				</div>
				<div class="row mt-5 pt-4 border-top">
          <div class="col-md-6 col-lg-8 mb-md-0 mb-4">
            <p class="copyright mb-0">Copyright ©2022 Todos los derechos reservados | Por Carlos Quintero & Brayan Pacheco</p>
          </div>
